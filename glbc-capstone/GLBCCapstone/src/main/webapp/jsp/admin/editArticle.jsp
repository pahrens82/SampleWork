        ...
        <div class="row">
            ...
            <div class="col-sm-offset-1 col-sm-5">
                <div class="row">
                    ...
                    <sf:form class="form-horizontal"
                        ...
                        <div class="form-group">
                            <label for="edit-article-userName" class="col-sm-4 control-label">User Name:</label>
                            <div class="col-sm-4">
                                <c:out value="${username}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit-article-article-name" class="col-sm-4 control-label">Article Title:</label>
                            <div class="col-sm-4">
                                <sf:input id="edit-article-article-name" 
                                          name="articleName" 
                                          placeholder="Title"
                                          path="articleName"
                                          class="form-control"/>
                        ...
                        <div class="form-group">
                            <label for="edit-article-summary" class="col-sm-4 control-label">Article Summary: </label>
                            <div class="col-sm-4">
                                <sf:input id="edit-article-summary" 
                                          name="articleSummary" 
                                          placeholder="Summary"
                                          path="summary"
                                          class="form-control"/>
                        ...
                        <div class="form-group">
                            <label for="edit-article-category" class="col-sm-4 control-label">Category:</label>
                            <div class="col-sm-4">
                        ...
                        <sec:authorize access="hasRole('ROLE_ADMIN')">
                            <div class="form-group">
                                <label for="edit-article-approval" class="col-sm-4 control-label">Approval:</label>
                                <div class="col-sm-4">
                                    <sf:radiobutton id="edit-article-approval" 
                                                    path="approval"
                                                    value="true"/> True
                                    <sf:radiobutton id="edit-article-approval" 
                                                    path="approval"
                ...
                <div class="form-group" display='none'>
                    <label for="edit-article-textBody" class="col-sm-offset-1 col-sm-4 control-label">Text Body </label>
                    <div class="col-sm-offset-1 col-sm-4">
                        <sf:textarea id="edit-article-textBody" 
